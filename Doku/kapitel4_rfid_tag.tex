...
Die Messung zeigt, dass der 5V-Wandler die Ausgangsspannung bis zu einem Strom von etwa $71\,mA$ stabil bei $5\,V$ halten kann. Bei einer weiteren Erhöhung des Laststroms fällt die Ausgangsspannung jedoch ab. Ab ungefähr $72\,mA$ beginnt der Spannungsregler einzubrechen, bei $79\,mA$ liegen nur noch etwa $1{,}8\,V$ an.
...
Die Kennlinie in \cref{fig:kennlinie_tag_5v_wandler} zeigt das typische Verhalten eines belasteten, kontaktlos versorgten Systems. Bis etwa $71\,mA$ steht am Ausgang eine stabile Versorgung von $5\,V$ zur Verfügung. Wird die Last darüber hinaus erhöht, reicht die übertragene Leistung nicht mehr aus und die Ausgangsspannung bricht ein. Damit ist der maximale sinnvoll nutzbare Arbeitspunkt des Tags erreicht.
