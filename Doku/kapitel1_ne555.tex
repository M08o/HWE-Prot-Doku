...
Die Schaltung \cref{fig:timerschaltung} besteht aus einem NE555 Timer-Baustein.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.35\linewidth, angle=-90]{Timerschaltung/NE555_Output_kalibriert}
